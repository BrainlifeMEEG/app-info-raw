...
This Brainlife App reads the .info attribute of a MNE/Raw instance and outputs it into a .txt file for ease of viewing

# Documentation

#### Input files are:
* a MEG/EEG Raw file in fif format (mne/Raw).
